...
USER_CFLAGS = -I/usr/include/libusb-1.0 -I ../../../libs/openFrameworks/ -I src/ofxKinect/src -pthread -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/libxml2  -pthread -lgstreamer-0.10 -lgobject-2.0 -lgmodule-2.0 -lxml2 -lgthread-2.0 -lrt -lglib-2.0
